...
Create table Customer (customer_id int, customer_name varchar(20), primary key (customer_id))
Create table Orders (order_id int, sale_date date, order_cost int, customer_id int, seller_id int, primary key (order_id))
Create table Seller (seller_id int, seller_name varchar(20), primary key (seller_id))
